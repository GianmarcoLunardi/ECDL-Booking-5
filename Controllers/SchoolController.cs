...
namespace Identity2.Controllers
{
    ...
    {
        private readonly IGenericRepository<School> RepoSchool;
        private readonly IGenericRepository<Class> RepoClass;

        public SchoolController(IGenericRepository<School> repoSchool,
            IGenericRepository<Class> repoClass
            )
        {
            RepoSchool = repoSchool;
            RepoClass = repoClass;
        }
        ...
        {
            var x = await RepoSchool.All();
            return View(x.AsQueryable());
        }
        ...
        public async Task<ActionResult> IndexClass(Guid id) {
            ...
            School x = await RepoSchool.Find(id);
                return View(x);
        }
       ...
       //[ValidateAntiForgeryToken]
        ...
        {
            await RepoSchool.Add(collection);
